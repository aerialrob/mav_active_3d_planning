...
namespace active_3d_planning
{
    ...
    {
        // SegmentLength
        ModuleFactoryRegistry::Registration<SegmentLength>
            SegmentLength::registration("SegmentLength");
        ...
        bool SegmentLength::computeCost(TrajectorySegment *traj_in, Eigen::Vector3d *current_position)
        {
        ...
        bool SegmentLength::setGlobalGoal(Eigen::Vector3d *goal)
        {
            return true;
        }
