...
namespace active_3d_planning
{
    namespace trajectory_evaluator
    {
        ...
        bool YawPlanningEvaluator::getObservedBoundingBox(std::vector<Eigen::Vector2d> *bounding_box)
        {
        ...
        bool YawPlanningEvaluator::computeCost(TrajectorySegment *traj_in, Eigen::Vector3d *current_position)
        {
