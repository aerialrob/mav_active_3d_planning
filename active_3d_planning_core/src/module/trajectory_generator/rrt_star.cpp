...
namespace active_3d_planning
{
    ...
    namespace trajectory_evaluator
    {
        ...
        bool RRTStarEvaluatorAdapter::computeCost(TrajectorySegment *traj_in, Eigen::Vector3d *current_position)
        {
        ...
        bool RRTStarEvaluatorAdapter::getObservedBoundingBox(std::vector<Eigen::Vector2d> *bounding_box)
        {
